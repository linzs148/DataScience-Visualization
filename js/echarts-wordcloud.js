					...
					external_echarts_.extendChartView({
						...
						render: function(seriesModel, ecModel, api) {
							...
							seriesModel.layoutInstance.ondraw = function(text, size, dataIdx, drawn) {
								...
								textEl.ensureState('emphasis').style = external_echarts_.helper.createTextStyle(itemModel.getModel([
									'emphasis', 'textStyle'
								]), {
									state: 'emphasis'
								});
								textEl.ensureState('blur').style = external_echarts_.helper.createTextStyle(itemModel.getModel([
									'blur', 'textStyle'
								]), {
									state: 'blur'
								});
